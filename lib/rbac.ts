  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: 'Upload',
        href: '/dashboard/admin/data-import',
        access: {
          SUPER_ADMIN: 'full',
          EXPERT: 'hidden',
          PILOTE_QVCT: 'hidden',
