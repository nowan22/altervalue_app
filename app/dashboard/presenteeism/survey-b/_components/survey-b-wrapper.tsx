...
import { SurveyManagement } from '../../../companies/[id]/_components/survey-management';

export function SurveyBWrapper() {
        ...
        <Card className="max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Sélectionnez une mission pour gérer les enquêtes.
            </p>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-display font-bold">Enquête B - Diagnostic Terrain</h1>
          <p className="text-muted-foreground">Campagnes d'enquête pour {data.company.name}</p>
        </div>
      </div>
